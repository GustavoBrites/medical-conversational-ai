...
TZ_INFO = os.getenv("TZ", "Europe/Lisbon")
tz = ZoneInfo(TZ_INFO)
...
def get_db_connection():
    return psycopg2.connect(
        ...
        database=os.getenv("POSTGRES_DB", "medical_conv_ai"),
        user=os.getenv("POSTGRES_USER", "llm_zoom"),
        password=os.getenv("POSTGRES_PASSWORD", "llm_zoom_pass"),
    )
